...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Facturación, Inventario y Compras 247| Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b></b>247</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>F.I.C</b></span>
        </a>
...
<div class="login-box">
      <div class="login-logo">
        <a href="./">Facturación, Inventario y Compras<b></b></a>
      </div><!-- /.login-logo -->
